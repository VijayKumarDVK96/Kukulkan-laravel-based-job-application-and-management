...
<body onload="checkFirstVisit()">
  ...
  <section class="login-block apply-block">
    <div class="container">
      <div class="row">
        <div class="login-sec apply-sec">
          <h2 class="text-center">APPLY JOB DETAILS</h2>
          <form action="" class="form" id="add_candidate" method="post" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id='desired_department' name='desired_department' class="autocomplete-select form-control">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id='desired_position' name='desired_position' class="autocomplete-select form-control">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id='desired_state' name='desired_state' class="autocomplete-select form-control">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id='desired_city' name='desired_city' class="autocomplete-select form-control">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <select id="working" name="working" class="autocomplete-select form-control">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <select id="current_salary_range" name="current_salary_range" class="autocomplete-select form-control">
                            ...
                            <div class="col-md-4">
                                ...
                                <select id="expected_salary_range" name="expected_salary_range" class="autocomplete-select form-control">
                                    <option value="">Select Salary Range</option>
                                    <?php
                                        foreach ($salary_range as $value) {
                                            echo '<option value="' . $value->id . '">' . $value->name . '</option>';
                            ...
                            <div class="col-md-4">
                                ...
                                <select id="notice_period" name="notice_period" class="autocomplete-select form-control">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12" style="margin-bottom: 20px">
                            ...
                            <button type="button" class="btn btn-warning pull-right add_college" data-toggle="modal" data-target="#addCollege">ADD COLLEGE</button>
                            <button type="button" class="btn btn-danger pull-right add_school" style="margin-right: 10px;" data-toggle="modal" data-target="#addSchool">ADD SCHOOL</button>
                            <div class="clear"></div>
                        </div>
                    </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if(data.status == 'success') {
                        $(".modal").modal('hide');
                        alert(data.message);
                        window.location.replace(base_url+"/upload-resume");
                    }
                },
                complete: function() {
