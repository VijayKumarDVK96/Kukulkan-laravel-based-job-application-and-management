...
<body onload="checkFirstVisit()">
  ...
  <section class="login-block">
    <div class="container">
      <div class="row">
        <div class="login-sec">
          <h2 class="text-center">POST JOB DETAILS</h2>
          <form action="" method="post" id="add_employer" class="form">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select id="desired_department" name="job_department" class="autocomplete-select form-control">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select id="desired_position" name="job_position" class="autocomplete-select form-control">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <button type="button" class="btn btn-warning pull-right" data-toggle="modal" data-target="#addJob">ADD JOB</button>
                            <div class="clear"></div>
                        </div>
                    </div>
                      ...
                      <div class="row">
                          <div class="col-md-4">
                              <div class="form-group">
                                  ...
                                  <input type="text" id="job_company_name" name="company_name" class="form-control">
                          ...
                          <div class="col-md-4">
                              <div class="form-group">
                                  ...
                                  <input type="text" id="job_company_address" name="company_address" class="form-control">
                          ...
                          <div class="col-md-4">
                              <div class="form-group">
                                  ...
                                  <input type="text" id="job_company_website" name="company_website" class="form-control">
                              </div>
                          </div>
                      </div>
                      ...
                      <div class="row">
                          <div class="col-md-3">
                              <div class="form-group">
                                  ...
                                  <select id="job_desired_department" name="desired_department_id" class="autocomplete-select form-control">
                                      <option value="">Select Job Sector</option>
                                      <?php
                                      foreach ($department as $value) {
                                          echo '<option value="' . $value->id . '">' . $value->name . '</option>';
                          ...
                          <div class="col-md-3">
                              <div class="form-group">
                                  ...
                                  <select id="job_desired_position" name="desired_position_id" class="autocomplete-select form-control">
                                      <option value="">Select Job Title</option>
                                      <?php
                                      foreach ($position as $value) {
                                          echo '<option value="' . $value->id . '">' . $value->name . '</option>';
                          ...
                          <div class="col-md-3">
                              <div class="form-group">
                                  ...
                                  <select id="job_state" name="desired_state_id" class="autocomplete-select form-control">
                          ...
                          <div class="col-md-3">
                              <div class="form-group">
                                  ...
                                  <select id="job_city" name="desired_city_id" class="autocomplete-select form-control">
                      ...
                      <div class="row">
                          <div class="col-md-3">
                              <div class="form-group">
                                  ...
                                  <input type="range" min="1" max="100" value="25" class="slider" id="fromRange" name="desired_age_from">
                          ...
                          <div class="col-md-3">
                              <div class="form-group">
                                  ...
                                  <input type="range" min="1" max="100" value="50" class="slider" id="toRange" name="desired_age_to">
                          ...
                          <div class="col-md-3">
                              <div class="form-group">
                                  ...
                                  <select id="job_gender" name="desired_gender" class="autocomplete-select form-control">
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <select id="job_experience" name="job_experience" class="autocomplete-select form-control">
                              ...
                              <div class="row">
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <select id="job_salary_range" name="job_salary_range_id" class="autocomplete-select form-control">
                                  ...
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <select id="job_type" name="job_work_type_id" class="autocomplete-select form-control">
                      ...
                      <div class="row">
                          ...
                          <div class="col-md-4">
                              <div class="form-group">
                                  ...
                                  <select id="contact_person_position_id" name="contact_person_position_id" class="autocomplete-select form-control">
                                      <option value="">Select Job Title</option>
                                      <?php
                                      foreach ($position as $value) {
                                          echo '<option value="' . $value->id . '">' . $value->name . '</option>';
